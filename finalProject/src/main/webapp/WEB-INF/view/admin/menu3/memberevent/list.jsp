    ...
    <div class="row form-group product-chooser" style="margin: 0px;">
    	...
    	<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="width: 48%; padding: 0px; margin-right: 10px;">
    		<div class="product-chooser-item selected">
    			<img src="<%=cp%>/resource/img/hhh.jpg" class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Mobile and Desktop" style="height: 185px; padding-top: 15px;">
    	...
    	<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="width: 48%; padding: 0px; float: right;">
    		<div class="product-chooser-item selected" >
    			<img src="<%=cp%>/resource/img/cool.jpg" class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Mobile and Desktop" style="height: 185px; padding-top: 15px;">
                <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
                    <br>
    	...
    	<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="width: 48%; padding: 0px; ">
    		<div class="product-chooser-item selected">
    			<img src="<%=cp%>/resource/img/bhc1.jpg" class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Mobile and Desktop" style="height: 185px; padding-top: 15px;">
                <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
                    <br>
    	...
    	<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="width: 48%; padding: 0px; float: right;">
    		<div class="product-chooser-item selected">
    			<img src="<%=cp%>/resource/img/qwe.png" class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Mobile and Desktop" style="height: 185px; padding-top: 15px;">
                <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
                    <br>
    	...
    	<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4" style="width: 48%; padding: 0px; margin-right: 10px;">
    		<div class="product-chooser-item selected">
    			<img src="<%=cp%>/resource/img/end.jpg" class="img-rounded col-xs-4 col-sm-4 col-md-12 col-lg-12" alt="Mobile and Desktop" style="height: 185px; padding-top: 15px;">
                <div class="col-xs-8 col-sm-8 col-md-12 col-lg-12">
                    <br>
