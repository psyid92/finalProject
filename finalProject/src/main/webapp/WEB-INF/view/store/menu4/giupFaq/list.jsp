...
<div class="panel-group" id="accordian${dto.f_Num}" role="tablist" aria-multiselectable="true" style="margin-bottom: 5px;">
	<div class="panel panel-default" >
		<div class="panel-heading" role="tab" id="heading${dto.f_Num}">
			<h4 class="panel-title" style="font-size: 14px; ">
				...
				<a data-toggle="collapse" data-parent="#accordian${dto.f_Num}" href="#collapse${dto.f_Num}" aria-expanded="true" aria-controls="collapse${dto.f_Num}">
					${dto.f_Title}
				</a>
			</h4>
		</div>
