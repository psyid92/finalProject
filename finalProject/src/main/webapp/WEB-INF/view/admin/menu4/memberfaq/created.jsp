...
<script type="text/javascript">
  function check() {
        ...
        var mode="${mode}";
    	if(mode=="created")
    		f.action="<%=cp%>/admin/memberfaq/created";
    	else if(mode=="update")
    		f.action="<%=cp%>/admin/memberfaq/update";
  ...
  <div class="bodyFrame2">
    ...
    <div>
        <form name="userFaqForm" method="post" onsubmit="return check();">
            <div class="bs-write">
                <table class="table">
                    <tbody id="tb">
                        <tr>
