...
public class Pay {
	private int orders_Num, jumun_Num, jumun_Pay, m1_Num;
	private int mainGoods_Num, mainmenu_Num, mainGoods_Count;
	private int subGoods_Num, submenu_Num;
	...
	public void setMainGoods_Count(int mainGoods_Count) {
		this.mainGoods_Count = mainGoods_Count;
	}
	...
	public void setSubGoods_Num(int subGoods_Num) {
		this.subGoods_Num = subGoods_Num;
	}
